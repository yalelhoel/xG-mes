var map = {
    ...
    init: function() {
        ...
        a.p([102.72, 3.54, -487.16], [0, 0, 0], [2, 6, 1], 1.0, 0);
        a.p([104.67, 1.53, -487.15], [0, 0, -1.57], [2, 6, 1], 1.0, 0);
        a.p([105.41, 4, -487.17], [0, 0, -0.79], [2, 8, 1], 1.0, 0);
    ...
    reset: function() {
        ...
        a.re('P31', [102.72, 3.54, -487.16], [0, 0, 0], [2, 6, 1]);
        a.re('P32', [104.67, 1.53, -487.15], [0, 0, -1.57], [2, 6, 1]);
        a.re('P33', [105.41, 4, -487.17], [0, 0, -0.79], [2, 8, 1]);
